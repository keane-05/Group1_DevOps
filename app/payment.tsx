        ...
        import { Text, View, StyleSheet, Alert, ScrollView, Linking, Pressable } from "react-native";
        ...
        const handlePayment = async () => {
                ...
                const response = await fetch('http://172.23.35.208:3000/create-payment-intent', {
                        method: 'POST',
